  ...
  <div class="flex flex-col min-h-screen">
    ...
    <section class="bg-indigo-600 text-white py-12">
      <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-lg md:text-xl">Browse all courses you are enrolled in</p>
      </div>
    </section>
    ...
    <section class="py-12 bg-gray-100 flex-1">
      <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold mb-8 text-center">Enrolled Courses</h2>
    ...
    onMounted(() => {
      ...
      courses.value = [
        ...
        },
        {
          ...
          description: "Learn programming, algorithms, and web development.",
          progress: 20,
